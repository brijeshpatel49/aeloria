...
export default function CartPage() {
  ...
  const handleSubmitOrder = (e) => {
    ...
    toast.success("Order sent! We'll contact you shortly on WhatsApp");
  };
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" onClick={() => setShowAddressModal(false)}>
          <div className="bg-white rounded-lg shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleSubmitOrder} className="p-4 sm:p-6">
              ...
              <div className="bg-rose p-4 rounded-lg mt-4">
                <p className="text-sm font-medium text-primary mb-2">Order Summary:</p>
                <p className="text-sm text-gray-700">{cart.length} item(s)</p>
                <p className="text-lg font-bold text-accent mt-2">Total: ₹{total}</p>
              </div>
